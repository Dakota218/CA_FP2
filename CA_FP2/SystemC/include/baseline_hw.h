...
struct Config {
  ...
  // ----------------------------------------------------------
  static constexpr int BUF_ARRAY_IN_SIZE = 2048;       // Bank 0
  static constexpr int BUF_ARRAY_OUT_SIZE = 2048;      // Bank 1
  static constexpr int BUF_VEC_IN_SIZE = 2048;         // Bank 2
  static constexpr int BUF_VEC_W_SIZE = 2048;          // Bank 3
  static constexpr int BUF_VEC_OUT_SIZE = 2048;        // Bank 4
  static constexpr int BUF_OTHER_IN_SIZE = 512;        // Bank 5
  static constexpr int BUF_OTHER_OUT_SIZE = 512;       // Bank 6
